...
Ниже — описание схемы «Программное средство реализации онлайн-сервиса интеллектуальной поддержки решения домашних заданий учащихся школ и студентов университета при помощи ИИ-ассистента» в том же стиле, что и твой пример.
